...
.variants
* `int64 strstr(char * s1, char * s2)`

`strstr` compares whether the string val1 contains the string val2.
If s2 is contained `0` is returned, else a non-zero value is returned.
