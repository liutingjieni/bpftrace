...
- [Functions](#functions)
    ...
    - [20. `strstr()`: Compare whether the string s1 contains the string s2.](#19-Compare-whether-the-string-s1-contains-the-string-s2)
...
- `strstr(char *s1, char *s2)` - Compares whether the string s1 contains the string s2.
...
## 20. `strstr()`: Compare whether the string s1 contains the string s2.
...
```
bpftrace -e 't:syscalls:sys_enter_execve /strstr(str(args->filename),"bin") == 0/ { @[comm, str(args->filename)] = count(); }'  
Attaching 1 probe...
